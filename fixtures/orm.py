...
class ORMFixture:
    ...
    def __init__(self, host, name, user, password):
        self.db.bind(
            'mysql', host=host, database=name, user=user, password=password  #,conv=decoders у меня отлично работает без этого, а с этим падает
        )
    ...
    def get_contacts_not_in_group(self, group):
        ...
        return self.convert_contacts_to_model(
            select(
                c for c in ORMFixture.ORMContact if c.deprecated is None and
